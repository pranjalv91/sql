...
```python
    cd "C:\Users\Pranjal Verlekar\Documents\VisualStudioCode\sql"
```
...
```python
    git remote add origin https://github.com/pranjalv91/sql.git
```
...
```python
    git commit -m "First commit from local sql directory to sql repository"
```
